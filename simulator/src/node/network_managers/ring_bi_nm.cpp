...
#include "ring_bi_nm.hpp"
#include "../../dot.hpp"
#include "nm.hpp"


XBT_LOG_NEW_DEFAULT_CATEGORY(s4u_ring_bi_nm, "Messages specific for this example");

using namespace std;
using namespace protocol;

RingBiNetworkManager::RingBiNetworkManager(NodeInfo node_info) : NetworkManager(node_info) {}

RingBiNetworkManager::~RingBiNetworkManager() {}

void RingBiNetworkManager::run()
{
    switch (this->state)
    {
        case INITIALIZING:
...
void RingBiNetworkManager::handle_registration_requests()
{
...
void RingBiNetworkManager::send_registration_request()
{
...
void RingBiNetworkManager::handle_registration_confirmation(const operations::RegistrationConfirmation &confirmation)
{
...
void RingBiNetworkManager::send_to_neighbour(const unique_ptr<Packet> &p, bool is_redirected) 
{
...
void RingBiNetworkManager::handle_kill_phase()
{
